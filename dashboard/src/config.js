  ...
  return new Settings({
    ...
    datasources: {
      influxdb: {
      	default: true,
        type: 'influxdb',
        url: "http://"+window.location.hostname+":8080/query",
	database: 'arms.log'
      },
    },

   // default start dashboard
   default_route: "/dashboard/file/search.json",
   cep_engine_url: "http://"+window.location.hostname+":8080",
   
   // elasticsearch url
   // used for storing and loading dashboards, optional
   // For Basic authentication use: http://username:password@domain.com:9200
   elasticsearch: "http://"+window.location.hostname,
   elasticsearch_indices: ["arms"],
