...
function (angular, $, _, PanelBaseCtrl) {
  ...
  angular
    ...
    .directive('kibanaPanel', function($compile, $timeout, $rootScope, $injector) {
	  ...
	  var title_style = "{{dashboard.current.style == 'dark' ? 'background-color: #161616;' : 'background-color: #ffffff;'}}";

      var panelHeader =
	  '<div class="body" style="'+title_style+'">' +
	  	'<span class="ng-scope" style="font-size:20px;"><b class="ng-binding">{{panel.title}}</b></span>' +
	  '</div>' +
