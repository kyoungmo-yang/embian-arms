 ...
 */
package com.embian.engine.camel.rabbitmq;
...
public class RabbitMQConsumer extends DefaultConsumer {
    ...
    protected void doStart() throws Exception {
        ...
        // modified by kyang: not used auto-delete, durable option for declaring queue
//        channel.queueDeclare(endpoint.getQueue(), endpoint.isDurable(), false,
//                endpoint.isAutoDelete(), null);
//        endpoint.setQueue(channel.queueDeclare().getQueue());
        channel.queueDeclare(endpoint.getQueue(), endpoint.isDurable(), true,
              true, null);
        channel.queueBind(
                endpoint.getQueue(),
